...
export default {
    ...
    methods:{
        approve:function () {
            this.loading=true
            this.$inertia.post(route('loan.approve',{code:this.loan.code}),{
                onFinish:()=>this.loading=false
            })
        },
        reject:function () {
            this.loading=true
            this.$inertia.post(route('loan.reject',{code:this.loan.code}),{
                onFinish:()=>this.loading=false
            })
        },
        close:function () {
            this.loading=true
            this.$inertia.post(route('loan.close',{code:this.loan.code}),{
                onFinish:()=>this.loading=false
            })
        },
        _default:function () {
            this.loading=true
            this.$inertia.post(route('loan.default',{code:this.loan.code}),{
                onFinish:()=>this.loading=false
            })
        },
...
//                duration=duration/1000; //seconds
        ...
        url(path){
            return this.$page.props.publicPathClient+path
        },
        closeModal() {
