...
<!--                            <div class="text-lg">
                            ...
                            >
                                <inertia-link v-if="notifications.type==='user_new'" :href="route('users.show',{'id':notifications.user.id})">
                                ...
                                <inertia-link v-else-if="notifications.type==='loan_new'" :href="route('users.show',{'id':notifications.user.id})">
                                    <div  class="my-2 flex items-center justify-start">
                                ...
                                <inertia-link v-else-if="notifications.type==='loan_apply'" :href="route('loan.show',{code:notifications.contents.loanCode})">
                                    <div  class="my-2 flex items-center justify-start">
...
<script>
    ...
    import EmployerNotification from "@/Pages/Components/EmployerNotification";
